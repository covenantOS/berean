...
- [ ] [SW] Notes, clippings, and prayer list printing. (Notes print from the Documents rail and clippings from the listdoc pane, both through the shared print idiom; prayer list printing awaits.)
