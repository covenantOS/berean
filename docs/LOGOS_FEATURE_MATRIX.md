...
- [ ] [SW] Docs indexing: notes and highlights flow into Docs Search and All Search. (Notes and highlights answer in Docs Search and All Search, read live from the collections so no indexing step exists.)
